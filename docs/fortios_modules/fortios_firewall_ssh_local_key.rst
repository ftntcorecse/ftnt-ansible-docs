...
**Name:** fortios_firewall_ssh_local_key

**Description:** This module is able to configure a FortiGate or FortiOS by allowing the user to configure firewall_ssh feature and local_key category. Examples includes all options and need to be adjusted to datasources before usage. Tested with FOS v6.0.2
...
- filter_firewall_ssh_local_key_data
